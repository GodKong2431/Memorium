...
public class skillModule2
{
    ...
    //public ShapeType M2Type => m2Type;

    public int M2ID; //고유 키
    public float M2Delay; //시전 딜레이
    public float M2S1; //시전 넓이 (가로)
    public float M2S2; //시전 넓이 (세로)
    public float M2Distance; //시전 거리 (플레이어와의 거리)
    public float M2Duration; //시전 시간
    public string desc; //주석
    public ShapeType M2Type;
}
